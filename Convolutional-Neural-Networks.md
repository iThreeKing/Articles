...
本教程的的目标是创建一个用于图像识别的相对小型的[卷积神经网络](https://en.wikipedia.org/wiki/Convolutional_neural_network)（CNN）。在这个过程中，本教程将会：
...
new ideas and experimenting with new techniques.之所以选择 CIFAR-10 数据集，
